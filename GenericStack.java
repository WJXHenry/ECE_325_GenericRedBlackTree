...
public class GenericStack<T> extends java.util.Vector<T> {
    ...
    public static Double calcPostfixExpression(String exp) {
        ...
        GenericStack<String> stack = new GenericStack<String>(exp.length());
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(String.valueOf(stack.capacity()));
